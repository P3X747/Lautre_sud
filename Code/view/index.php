        ...
        <div class="toggle-menu-container">
            <nav class="nav">
                ...
                <ul class="sf-menu">
                    ...
                    <li>
                        <a href="index-1.php">Qui sommes-nous?</a>
                        <ul>
                          <li>
                              <a href="#">Pierre</a>
                          </li>
                    ...
                    <li>
                        <a href="index-1.php">Patisserie</a>
                        <ul>
                          <li>
                      ...
                      <li>
                        <a href="index-1.php">Restaurant</a>
                        <ul>
                          <li>
                              <a href="#">Entree</a>
                          </li>
                      ...
                      <li>
                        <a href="index-1.php">Connexion</a>
                        <ul>
                            <li>
