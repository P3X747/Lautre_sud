...
class Index_view extends Abstract_view
{
  ...
  public function set_html_head()
  {
    ...
    <link rel="icon" href=http:\\localhost\Lautre_sud\Code\view\template\images\favicon.ico" type="image/x-icon">
  ...
  public function get_index_main()
  {
    ...
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img03.jpg" alt="">
    ...
    <a data-fancybox-group="gallery" href=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img04_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 74.13793103448276%;">
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img04.jpg" alt="">
    <div class="gallery_overlay">
    <div class="gallery_caption">
    <p><em>Lorem Blandit</em></p>
    <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
    ...
    <a data-fancybox-group="gallery" href=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img05_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 94.6551724137931%;">
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img05.jpg" alt="">
    <div class="gallery_overlay">
    <div class="gallery_caption">
    <p><em>Lorem Blandit</em></p>
    <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
    ...
    <a data-fancybox-group="gallery" href=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img06_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 52.48322147651007%;">
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img06.jpg" alt="">
    <div class="gallery_overlay">
    <div class="gallery_caption">
    <p><em>Lorem Blandit</em></p>
    <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
    ...
    <a data-fancybox-group="gallery" href=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img07_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 55.97315436241611%;">
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img07.jpg" alt="">
    <div class="gallery_overlay">
    <div class="gallery_caption">
    <p><em>Lorem Blandit</em></p>
    <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
    ...
    <a data-fancybox-group="gallery" href=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img08_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 96.10738255033557%;">
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img08.jpg" alt="">
    <div class="gallery_overlay">
    <div class="gallery_caption">
    <p><em>Lorem Blandit</em></p>
    <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
    ...
    <a data-fancybox-group="gallery" href=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img09_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 93.69676320272572%;">
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img09.jpg" alt="">
    <div class="gallery_overlay">
    <div class="gallery_caption">
    <p><em>Lorem Blandit</em></p>
    <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
    ...
    <a data-fancybox-group="gallery" href=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img10_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 72.23168654173765%;">
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img10.jpg" alt="">
    <div class="gallery_overlay">
    <div class="gallery_caption">
    <p><em>Lorem Blandit</em></p>
    <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
    ...
    <a data-fancybox-group="gallery" href=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img11_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 93.69676320272572%;">
    <img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img11.jpg" alt="">
    <div class="gallery_overlay">
    <div class="gallery_caption">
    <p><em>Lorem Blandit</em></p>
    <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
    ...
    <div class="grid_4">
    <figure>
    <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img12.jpg" alt=""></div>
    ...
    <div class="grid_4">
    <figure>
    <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img13.jpg" alt=""></div>
    ...
    <div class="grid_4">
    <figure>
    <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img data-src=http:\\localhost\Lautre_sud\Code\view\template\images\page-1_img14.jpg" alt=""></div>
